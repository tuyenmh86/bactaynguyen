...
<?php $__currentLoopData = $combinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $combination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	...
	<?php if(strlen($str) > 0): ?>
			<tr>
				...
				<td>
					<input type="number" min="0" value="0" step="" placeholder="giảm giá" name="discount_<?php echo e($str); ?>" class="form-control">
				</td>
				<td>
...
<?php /**PATH D:\xampp72\htdocs\bds\resources\views/partials/sku_combinations.blade.php ENDPATH**/ ?>
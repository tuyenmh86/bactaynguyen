...
<section class="hero-wrap hero-wrap-2" style="background-image: url('<?php echo e(asset($post->category->banner)); ?>');">
    <div class="overlay"></div>
    <div class="container">
       <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
             <h1 class="mb-2 bread"><?php echo e($post->category->name); ?></h1>
             <p class="breadcrumbs"><span class="mr-2"><a href="/">Trang chủ <i class="ion-ios-arrow-forward"></i></a></span> <span><?php echo e($post->category->name); ?> <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
       </div>
    </div>
 </section>
...
<?php echo $__env->make('frontend.layouts.edu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp72\htdocs\mamnonhoahong\resources\views/frontend/edu/post_detail.blade.php ENDPATH**/ ?>
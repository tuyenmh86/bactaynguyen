...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="container">
            <form class="form form-horizontal mar-top" action="<?php echo e(route('widget.update',$widget->id)); ?>" method="POST"
                            ...
                            <div class="tab-content">
                                <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="name" placeholder="Tên widget"
                                                   value="<?php echo e($widget->name); ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Chèn mã</label>
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" disabled name="alias" placeholder="Insert Code"
                                                   value="<?php echo e($widget->alias); ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control" name="description"
                                                   placeholder="<?php echo e($widget->description); ?>" value="<?php echo e($widget->description); ?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Mã HTML</label>
                                        <div class="col-lg-9">
                                            <textarea class="editor" id="content" name="content"><?php echo e($widget->content); ?></textarea>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <textarea class="editor" id="style" name="style"><?php echo e($widget->style); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Mã Javascript</label>
                                        <div class="col-lg-9">
                                            <textarea class="editor" id="script" name="script"><?php echo e($widget->script); ?></textarea>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp72\htdocs\mamnonhoahong\resources\views/widget/edit.blade.php ENDPATH**/ ?>
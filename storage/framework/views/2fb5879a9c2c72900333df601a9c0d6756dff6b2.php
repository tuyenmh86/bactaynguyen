        ...
        <div class="panel">
            ...
            <form class="form-horizontal" action="<?php echo e(route('generalsettings.logo.store')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="seach_background"> Hình nền trang chủ <small>(550x400)</small></label>
                        <div class="col-sm-9">
                            <input type="file" id="seach_background" name="seach_background" class="form-control">
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp73\htdocs\mamnonhoahong\resources\views/general_settings/logo.blade.php ENDPATH**/ ?>
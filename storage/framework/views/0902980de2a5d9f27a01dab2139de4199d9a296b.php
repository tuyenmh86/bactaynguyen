							...
							<div class="form-group" id="category">
                                ...
                                <div class="col-lg-9">
                                    <select id="category_id" name="category_id" class="form-control" size="1">
                                        <option value="0">-- <?php echo e(__('Parent Category')); ?> --</option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp72\htdocs\hoahong\resources\views/posts/create.blade.php ENDPATH**/ ?>
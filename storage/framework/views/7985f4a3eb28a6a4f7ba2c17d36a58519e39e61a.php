                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="<?php echo e(areActiveRoutes(['subcategories.index', 'subcategories.create', 'subcategories.edit'])); ?>">
                                        <a class="nav-link" href="<?php echo e(route('subcategories.index')); ?>">Danh mục cấp 2</a>
                                    </li>
                                    <li class="<?php echo e(areActiveRoutes(['subsubcategories.index', 'subsubcategories.create', 'subsubcategories.edit'])); ?>">
                                        <a class="nav-link" href="<?php echo e(route('subsubcategories.index')); ?>">Danh mục cấp 3</a>
                                    </li>
                                    <li class="<?php echo e(areActiveRoutes(['products.admin', 'products.create', 'products.admin.edit'])); ?>">
                                        <a class="nav-link" href="<?php echo e(route('products.admin')); ?>">Sản phẩm</a>
                                    </li>
                                ...
                                <ul class="collapse">
                                    <?php if(Auth::user()->user_type == 'admin'): ?>
                                        <li class="<?php echo e(areActiveRoutes(['khoahoc.userCourse'])); ?>">
                                            <a class="nav-link" href="<?php echo e(route('khoahoc.userCourse')); ?>">Kích hoạt khóa
                                                học</a>
                                        </li>
                        ...
                        <?php endif; ?>
                            ...
                            <li class="<?php echo e(areActiveRoutes(['orders.index.admin', 'orders.show'])); ?>">
                                <a class="nav-link" href="<?php echo e(route('orders.index.admin')); ?>">
                                    ...
                                    <span class="menu-title"><?php echo e(__('Hóa đơn')); ?> <?php if($orders > 0): ?><span
                        ...
                        <?php if(Auth::user()->user_type == 'admin' || in_array('16', json_decode(Auth::user()->staff->role->permissions))): ?>
                            <?php if(Auth::user()->user_type == 'admin'): ?>
                                <li class="<?php echo e(areActiveRoutes(['staffs.index'])); ?>">
                                    <a class="nav-link" href="<?php echo e(route('staffs.index')); ?>">Quản lý đại lý</a>
                                </li>
                            <?php endif; ?>
                            <?php if(Auth::user()->user_type == 'staff'): ?>
                                <li class="<?php echo e(areActiveRoutes(['staffs.index'])); ?>">
                                    <a class="nav-link" href="<?php echo e(route('staffs.index')); ?>">Quản lý học viên</a>
                                </li>
                            <?php endif; ?>
                        <?php endif; ?>
                    </ul>
...
<?php /**PATH /home/u751835082/domains/chuoisaygion.com/public_html/resources/views/inc/admin_sidenav.blade.php ENDPATH**/ ?>
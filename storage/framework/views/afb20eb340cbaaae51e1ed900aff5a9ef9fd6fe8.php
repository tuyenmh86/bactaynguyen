...
<div class="container">
    ...
    <div class="row">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco_navbar ftco-navbar-light w-100" id="ftco-navbar">
                ...
                <div class="row">
                    <div class="collapse navbar-collapse" id="ftco-nav">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item"><a class="nav-link  dropdown-toggle" href="<?php echo e(route('gioithieu')); ?>" class="nav-link">Giới thiệu</a></li>
...
<?php /**PATH E:\xampp73\htdocs\bactaynguyen\resources\views/frontend/edu/header.blade.php ENDPATH**/ ?>
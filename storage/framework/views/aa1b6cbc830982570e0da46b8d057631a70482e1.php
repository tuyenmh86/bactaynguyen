...
<div class="row">
    ...
    <div class="col-lg-6">
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title text-center"><?php echo e(__('VNPAY')); ?></h3>
                </div>
                <div class="panel-body">
                    <form class="form-horizontal" action="<?php echo e(route('payment_method.update')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-3">
                                <label class="control-label"><?php echo e(__('vnp_TmnCode')); ?></label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="vnp_TmnCode" value="<?php echo e(\App\BusinessSetting::where('type', 'vnp_TmnCode')->first()->value); ?>" placeholder="vnp_TmnCode" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <input type="hidden" name="types[]" value="vnp_HashSecret ">
                            <div class="col-lg-3">
                                <label class="control-label"><?php echo e(__('vnp_HashSecret')); ?></label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="vnp_HashSecret " value="<?php echo e(\App\BusinessSetting::where('type', 'vnp_HashSecret')->first()->value); ?>" placeholder="vnp_HashSecret" required>
                            </div>
                        </div>
                        <div class="form-group">
                                <div class="col-lg-3">
                                    <label class="control-label"><?php echo e(__('VNpay Sandbox Mode')); ?></label>
                                </div>
                                <div class="col-lg-6">
                                    <label class="switch">
                                        <input value="1" name="vnpay_sandbox" type="checkbox" <?php if(\App\BusinessSetting::where('type', 'vnpay_sandbox')->first()->value == 1): ?>
                                            checked
                                        <?php endif; ?>>
                                        <span class="slider round"></span>
                                    </label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u751835082/domains/chuoisaygion.com/public_html/resources/views/business_settings/payment_method.blade.php ENDPATH**/ ?>
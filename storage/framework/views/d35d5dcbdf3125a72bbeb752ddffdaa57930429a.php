                            ...
                            <div class="tab-content">
                                <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control myEditor" name="description"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <textarea class="myEditor" id="content" name="content"><?php echo e($page->content); ?></textarea>
                                        </div>
                                    </div>
                                ...
                                <div id="demo-stk-lft-tab-2" class="tab-pane fade">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <textarea name="meta_description" rows="8" class="form-control myEditor"><?php echo e($page->seo_description); ?></textarea>
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Hình nền</label>
                                        <div class="col-lg-7">
                                            <div id="background">
                                                <?php if($page->background != null): ?>
                                                    <div class="col-md-4 col-sm-4 col-xs-6">
                                                        <div class="img-upload-preview">
                                                            <img src="<?php echo e(asset($page->background)); ?>" alt="" class="img-responsive">
                                                            <input type="hidden" name="previous_background" value="<?php echo e($page->background); ?>">
                                    ...
                                    <div class="form-group">
                                        <label class="col-lg-2 control-label">Hình ảnh đặc trưng</label>
                                        <div class="col-lg-7">
                                            <div id="featured_img">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp72\htdocs\mamnonhoahong\resources\views/page/edit.blade.php ENDPATH**/ ?>
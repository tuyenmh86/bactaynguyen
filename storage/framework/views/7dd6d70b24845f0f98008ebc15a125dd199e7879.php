...
<section class="mb-4">
                ...
                <?php if($flash_deal != null && strtotime(date('d-m-Y')) >= $flash_deal->start_date && strtotime(date('d-m-Y')) <= $flash_deal->end_date): ?>
                    <div class="col-lg-12 d-lg-block"> 
                        <div class="section-title-1 clearfix">
                            ...
                            <div class="countdown countdown--style-2 countdown--style-2-v1" data-countdown-date="<?php echo e(date('m/d/Y', $flash_deal->end_date)); ?>" data-countdown-label="show"></div>
                        </div>
    ...
    <?php endif; ?><?php /**PATH /home/u751835082/domains/chuoisaygion.com/public_html/resources/views/frontend/partials/flashDeal.blade.php ENDPATH**/ ?>
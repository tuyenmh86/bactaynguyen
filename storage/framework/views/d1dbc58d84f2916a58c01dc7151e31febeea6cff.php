<?php $__env->startSection('content'); ?>
    ...
    <div class="tab-base">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-6" aria-expanded="true"><?php echo e(__('Albums')); ?></a>
            </li>
            <li class="">
                            ...
                            <tbody>
                                <?php $__currentLoopData = \App\Slider::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($slider->album_id); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp73\htdocs\mamnonhoahong\resources\views/home_settings/index.blade.php ENDPATH**/ ?>
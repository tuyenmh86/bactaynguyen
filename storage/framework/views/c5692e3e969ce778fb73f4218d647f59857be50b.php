...
<?php $__currentLoopData = $combinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $combination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	<?php
		$sku = '';
		foreach (explode(' ', to_slug($product_name)) as $key => $value) {
	...
	<?php if(strlen($str) > 0): ?>
		<tr>
			...
			<td>
				...
				?>" step="" placeholder="giảm giá" name="discount_<?php echo e($str); ?>" class="form-control">
			</td>
			<td>
...
<?php /**PATH D:\xampp72\htdocs\mekendy\resources\views/partials/sku_combinations_edit.blade.php ENDPATH**/ ?>
   ...
   <div class="home-index">
      ...
      <div class="row">
         <div class="col-md-12 col-12">
            ...
            <?php $__currentLoopData = \App\Post::where('category_id',34)->where('published',1)->where('featured',1)->orderBy('created_at')->take(6)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tinnoibat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <div class="">
                  
                  <?php echo $tinnoibat->content; ?>

                  <h5><a href="<?php echo e($tinnoibat->link()); ?>"><?php echo e($tinnoibat->name); ?></a></h5>
               </div>
   ...
   <div class="home-index">
      ...
      <div class="row">
         ...
         <div class="col-md-6 col-12">
            <ul class="">
               <?php $__currentLoopData = \App\Post::where('category_id',$category->id)->where('featured',1)->take(8)->orderBy('created_at','desc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <li class=""><a href="<?php echo e($post->link()); ?>"><?php echo e($post->name); ?></li>
               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.layouts.edu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp73\htdocs\bactaynguyen\resources\views/frontend/edu/index.blade.php ENDPATH**/ ?>
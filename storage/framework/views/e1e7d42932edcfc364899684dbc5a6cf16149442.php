        ...
        <form class="form-horizontal" action="<?php echo e(route('sellers.update', $seller->id)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="<?php echo e(__('Name')); ?>" id="name" name="name" class="form-control" value="<?php echo e($seller->user->name); ?>" required>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label" for="email"><?php echo e(__('Email Address')); ?></label>
                    <div class="col-sm-9">
                        <input type="text" placeholder="<?php echo e(__('Email Address')); ?>" id="email" name="email" class="form-control" value="<?php echo e($seller->user->email); ?>" required>
                    </div>
                </div>
                <div class="form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp72\htdocs\bds\resources\views/sellers/edit.blade.php ENDPATH**/ ?>
...
<!DOCTYPE html>
        ...
        <html>
        <head>
            <link rel="shortcut icon" href="<?php echo e(asset(\App\GeneralSetting::first()->favicon)); ?>">
            <meta charset="utf-8">
...
<link rel="stylesheet" href="<?php echo e(asset('frontend/css/footer.css')); ?>" type="text/css">
        ...
        <div class="body-wrap shop-default shop-cards shop-tech bg-white">
            ...
            <?php echo $__env->make('frontend.inc.navseach', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH D:\xampp72\htdocs\bds\resources\views/frontend/layouts/bds.blade.php ENDPATH**/ ?>
        ...
        <div class="panel">
            ...
            <form class="form-horizontal" action="<?php echo e(route('postcategory.update',$category->id)); ?>" method="POST"
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" placeholder="Tên thư mục ảnh không dấu - gạch ngang mỗi khoảng cách" id="folder" name="folder" class="form-control"
                                   value="<?php echo e($category->folder); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select name="categories_product[]" id="categories_product" class="form-control demo-select2" multiple  required data-placeholder="Choose Brands">
                                <?php $__currentLoopData = $categories_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categories_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($categories_product->id); ?>"><?php echo e($categories_product->name); ?></option>
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label"><?php echo e(__('Icon')); ?> <small>(290x300)</small></label>
                        <div class="col-lg-7">
                            <div id="icon">
                                <?php if($category->icon != null): ?>
                                    <div class="col-md-4 col-sm-4 col-xs-6">
                                        <div class="img-upload-preview">
                                            <img src="<?php echo e(asset($category->icon)); ?>" alt="" class="img-responsive">
                                            <input type="hidden" name="previous_thumbnail_img" value="<?php echo e($category->icon); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp72\htdocs\bds\resources\views/categoriespost/edit.blade.php ENDPATH**/ ?>
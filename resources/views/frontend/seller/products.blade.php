                                        ...
                                        @foreach ($products as $key => $product)
                                            <tr>
                                                ...
                                                <td><label class="switch">
                                                    <input disabled onclick="update_published(this)" value="{{ $product->id }}" type="checkbox" <?php if($product->published == 1) echo "checked";?> >
                                                    <span class="slider round"></span></label>
                                                </td>
                                                <td><label class="switch">
                                                    <input disabled onclick="update_featured(this)" value="{{ $product->id }}" type="checkbox" <?php if($product->featured == 1) echo "checked";?> >
                                                    <span class="slider round"></span></label>
                                                </td>
                                                <td>
                                                    <label class="switch">
                                                    <input disabled value="{{ $product->id }}" type="checkbox" <?php if($product->vip1 == 1) echo "checked";?> >
                                                    <span class="slider round"></span></label>
                                                </td>
                                                <td><label class="switch">
                                                    <input disabled value="{{ $product->id }}" type="checkbox" <?php if($product->vip2 == 1) echo "checked";?> >
                                                    <span class="slider round"></span></label>
                                                </td>
                                                <td>
                                                    <div class="dropdown">

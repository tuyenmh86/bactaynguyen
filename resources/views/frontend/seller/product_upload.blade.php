                        ...
                        <form class="" action="{{route('products.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>Chọn tỉnh <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <select class="form-control selectpicker" name="provice" id="province_id" required>
                                            @foreach($provices as $provice)
                                                    @if ($provice->id===41)
                                                        <option value="{{$provice->id}}" selected>{{__($provice->name)}}</option>
                                                    @else
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>Thành phố/Quận/Huyện <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <select class="form-control mb-3 selectpicker" data-placeholder="Chọn TP/Quận/Huyện" id="district_id" name="district_id" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <select class="form-control mb-3 selectpicker" data-placeholder="Chọn phường xã" id="ward_id" name="ward_id" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>Địa chỉ <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>Diện tích <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="input-group">
                                                <input id="dientich" name="dientich" placeholder="Ví dụ: 5x20" type="text" class="form-control">
                                              </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>Hướng đất <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="input-group">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    <div id="product-images">
                                        <div class="row">
                                            <div class="col-md-2">
                                                <label>Hình ảnh bất động sản <span class="required-star">*</span></label>
                                            </div>
                                            <div class="col-md-10">

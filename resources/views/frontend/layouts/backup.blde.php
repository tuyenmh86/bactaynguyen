...
<head>
    ...
    <title>@yield('meta_title', config('app.name', 'Đào tạo kiếm tiền Online'))</title>
    ...
    <!-- Open Graph data -->
    <meta property="og:title" content="{{ $sitesetting->site_name }}" />
    <meta property="og:type" content="video.movie" />
    <meta property="og:image:alt" content="Học kiếm tiền online " />
    <meta property="og:url" content="{{ $sitesetting->site_url }}" />
    <meta property="og:image" content="{{ asset($sitesetting->admin_logo) }}" />

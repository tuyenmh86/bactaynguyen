                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('3', json_decode(Auth::user()->staff->role->permissions)))
                            <li class="{{ areActiveRoutes(['pages', 'page.create','page.edit'])}}">
                                <a class="nav-link" href="{{ route('pages') }}">
                                    ...
                                    <span class="menu-title">{{__('Trang cá nhân')}}</span>
                                </a>
                            </li>
                        @endif
                    <!-- Post Menu -->
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="{{ areActiveRoutes(['subcategories.index', 'subcategories.create', 'subcategories.edit'])}}">
                                        <a class="nav-link" href="{{route('subcategories.index')}}">Danh mục cấp 2</a>
                                    </li> 
                                    <li class="{{ areActiveRoutes(['subsubcategories.index', 'subsubcategories.create', 'subsubcategories.edit'])}}">
                                        <a class="nav-link" href="{{route('subsubcategories.index')}}">Danh mục cấp 3</a>
                                    </li>
                                    <li class="{{ areActiveRoutes(['products.admin', 'products.create', 'products.admin.edit'])}}">
                                        <a class="nav-link" href="{{route('products.admin')}}">Sản phẩm tự đăng</a>
                                    </li>
                                   <li class="{{ areActiveRoutes(['products.admin', 'products.create', 'products.admin.edit'])}}">
                                       <a class="nav-link" href="{{route('session.create')}}">Chương </a>
                                   </li>
                                   <li class="{{ areActiveRoutes(['products.admin', 'products.create', 'products.admin.edit'])}}">
                                       <a class="nav-link" href="{{route('lesson.create')}}"> Bài học</a>
                                   </li>

                                    @if(\App\BusinessSetting::where('type', 'vendor_system_activation')->first()->value == 1)
                                        <li class="{{ areActiveRoutes(['products.seller', 'products.seller.edit'])}}">
                                            <a class="nav-link" href="{{route('products.seller')}}">Sản phẩm của khách hàng</a>
                                        </li>
                                    @endif
                                    <li class="{{ areActiveRoutes(['reviews.index'])}}">
                                        <a class="nav-link" href="{{route('reviews.index')}}">Đánh giá của khách</a>
                                    </li>
                                </ul>
                            </li>
                        @endif --}}
                    <!-- Hoa hồng  -->
                        {{-- @if(Auth::user()->user_type == 'admin'||Auth::user()->user_type=='staff')
                            <li class="">
                                <a href="#">
                                    <i class="fa fa-shopping-cart"></i>
                                    <span class="menu-title">Hoa Hồng</span>
                                    <i class="arrow"></i>
                                </a>
                                ...
                                <ul class="collapse">
                                    @if(Auth::user()->user_type == 'admin')
                                        <li class="{{ areActiveRoutes(['khoahoc.userCourse'])}}">
                                            <a class="nav-link" href="{{route('khoahoc.userCourse')}}">Kích hoạt khóa
                                                học</a>
                                        </li>
                                        <li class="{{ areActiveRoutes(['commission.index'])}}">
                                            <a class="nav-link" href="{{route('commission.index')}}">
                                                <i class="fa fa-bolt"></i>
                                                <span class="menu-title">Hoa hồng của đại lý</span>
                                            </a>
                                        </li>
                                    @endif
                                        ...
                                        <li class="{{ areActiveRoutes(['commission.staffCommission'])}}">
                                            <a class="nav-link"
                                               href="{{route('commission.staffCommission',Auth::user()->id)}}">
                                                <i class="fa fa-bolt"></i>
                                                <span class="menu-title">Hoa hồng của bạn</span>
                                            </a>
                                        </li>
                                    @endif
                                </ul>
...
{{--                        @if(Auth::user()->user_type == 'admin' || in_array('1', json_decode(Auth::user()->staff->role->permissions)))--}}
                            ...
                            <li class="{{ areActiveRoutes(['orders.index.admin', 'orders.show'])}}">
                                <a class="nav-link" href="{{ route('orders.index.admin') }}">
                                    ...
                                    <span class="menu-title">{{__('Hóa đơn')}} @if($orders > 0)<span
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="{{ areActiveRoutes(['contacts.index'])}}">
                                        <a class="nav-link"
                                           href="{{route('contacts.index')}}">{{__('Khách liên hệ')}}</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
                        ...
                        {{-- @if(Auth::user()->user_type == 'admin' || in_array('16', json_decode(Auth::user()->staff->role->permissions)))
                            @if(Auth::user()->user_type == 'admin')
                                <li class="{{ areActiveRoutes(['staffs.index'])}}">
                                    <a class="nav-link" href="{{ route('staffs.index') }}">Quản lý đại lý</a>
                                </li>
                            @endif
                            @if(Auth::user()->user_type == 'staff')
                                <li class="{{ areActiveRoutes(['staffs.index'])}}">
                                    <a class="nav-link" href="{{ route('staffs.index') }}">Quản lý học viên</a>
                                </li>
                            @endif
                        @endif --}}
                    </ul>

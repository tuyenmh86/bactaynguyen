                        ...
                        <tr>
                           ...
                           {{-- <td>
                            ...
                            <td>
                                ...
                                <input onchange="update_vip1(this)" value="{{ $product->id }}" type="checkbox" <?php if($product->vip1 == 1) echo "checked";?> >
                                    <span class="slider round"></span></label>
                                    <br/>
                                    VIP 2:<label class="switch">
                                    <input onchange="update_vip2(this)" value="{{ $product->id }}" type="checkbox" <?php if($product->vip2 == 1) echo "checked";?> >
                                        <span class="slider round"></span></label>
                                        <br/>
                            </td>
...
@section('script')
    <script type="text/javascript">
        ...
        function update_vip1(el){
            ...
            $.post('{{ route('products.vip1') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
                    showAlert('success', 'Featured products updated successfully');
                }
                else{
        ...
        function update_vip2(el){
            ...
            $.post('{{ route('products.vip2') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
                    showAlert('success', 'Featured products updated successfully');
                }
                else{

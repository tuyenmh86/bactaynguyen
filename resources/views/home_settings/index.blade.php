...
@section('content')
    ...
    <div class="tab-base">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="">
                <a data-toggle="tab" href="#demo-lft-tab-6" aria-expanded="true">{{ __('Albums') }}</a>
            </li>
            <li class="">
                            ...
                            <tbody>
                                @foreach(\App\HomeCategory::all() as $key => $home_category)
                                    <tr>
                                        ...
                                        <td>
                                            {{-- @foreach (json_decode($home_category->subcategories) as $key => $subcategory_id)

                                                @if (\App\SubCategory::find($subcategory_id) != null)
                                                    <span class="badge badge-info">{{\App\SubCategory::find($subcategory_id)->name}}</span>
                                                @endif

        ...
        <div class="panel">
            ...
            <form class="form-horizontal" action="{{ route('generalsettings.update',$generalsetting->id ) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="name">{{__('Site Url')}}</label>
                        <div class="col-sm-9">
                            <input type="text" id="site_url" name="site_url" value="{{ $generalsetting->site_url }}" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="sologun" name="sologun" value="{{ $generalsetting->sologun }}" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="address">Mô tả sologun</label>
                        <div class="col-sm-9">
                            <input type="text" id="sologun_description" name="sologun_description" value="{{ $generalsetting->sologun_description }}" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label" for="name">Văn bản chân trang</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="zalo" name="zalo" value="{{ $generalsetting->zalo }}" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group">

                            ...
                            <div class="tab-content">
                                <div id="demo-stk-lft-tab-1" class="tab-pane fade active in">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <textarea class="myEditor" id="content" name="content">{{$page->content}}</textarea>
                                        </div>
                                    </div>
                                ...
                                <div id="demo-stk-lft-tab-2" class="tab-pane fade">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-7">
                                            <textarea name="meta_description" rows="8" class="form-control myEditor">{{ $page->seo_description }}</textarea>
                                        </div>
                                    </div>
                                                ...
                                                @if ($page->background != null)
                                                    <div class="col-md-4 col-sm-4 col-xs-6">
                                                        <div class="img-upload-preview">
                                                            <img src="{{ asset($page->background) }}" alt="" class="img-responsive">
                                                            <input type="hidden" name="previous_background" value="{{ $page->background }}">

...
Route::get('/link', function () {
    ...
    return '<h1>đã tạo link_storage</h1>';
});
...
Route::get('/tuyen-sinh', 'HomeController@tuyensinh')->name('tuyensinh');
...
Route::get('/thu-vien-anh', 'HomeController@thuvienanh')->name('thuvienanh');
Route::get('/thu-vien-anh/{id}', 'HomeController@thuvienanh_chitiet')->name('thuvienanh-chitiet');
Route::get('/khuyen-mai', 'HomeController@khuyenmai')->name('khuyenmai');
Route::get('/catalogue', 'HomeController@catalogue')->name('catalogue');
Route::get('/tim-kiem', 'HomeController@eduSearch')->name('edu_seach');

Route::get('/generate-docx', 'HomeController@generateDocx');
// Quy trinh TCHC 05
Route::get('/iso_tchc_cntt_qt01_bm01', 'HomeController@iso_tchc_cntt_qt01_bm01');
Route::get('/iso_tchc_cntt_qt01_bm02', 'HomeController@iso_tchc_cntt_qt01_bm02');
Route::get('/iso_tchc_cntt_qt01_bm04', 'HomeController@iso_tchc_cntt_qt01_bm04');
Route::get('/iso_tchc_cntt_qt01_bm05', 'HomeController@iso_tchc_cntt_qt01_bm05');
Route::get('/iso_tchc_cntt_qt01_bm06', 'HomeController@iso_tchc_cntt_qt01_bm06');
// Quy trinh TCHC 06
Route::get('/iso_tchc_cntt_qt02_bm01', 'HomeController@iso_tchc_cntt_qt02_bm01');
Route::get('/iso_tchc_cntt_qt02_bm02', 'HomeController@iso_tchc_cntt_qt02_bm02');
Route::get('/iso_tchc_cntt_qt02_bm04', 'HomeController@iso_tchc_cntt_qt02_bm04');

Route::get('/san-pham', 'HomeController@listing')->name('products');
Route::get('/san-pham/{slug}', 'HomeController@product')->name('product');

Route::get('/danh-muc/{slug}', 'HomeController@spdanhmuc')->name('category.slug');
Route::get('/danh-muc-2/{slug}', 'HomeController@subcategory')->name('subcategory.slug');
Route::get('/danh-muc-3/{slug}', 'HomeController@subsubcategory')->name('subsubcategory.slug');
...
Route::get('/advance_search', 'HomeController@advanceSearch')->name('advanceSearch');
Route::get('/result_search', 'HomeController@resultAdvanceSearch')->name('resultAdvanceSearch');
...
Route::get('/chuong-trinh-cho-be', 'HomeController@course')->name('course');
Route::get('/chuong-trinh-hoc/tu-van-giao-duc', 'HomeController@tuvangiaoduc')->name('tu-van-giao-duc');
Route::get('/chuong-trinh-hoc/phuong-phap-giao-duc', 'HomeController@phuongphapgiaoduc')->name('phuong-phap-giao-duc');
Route::get('/chuong-trinh-hoc/chuong-trinh-giao-duc', 'HomeController@chuongtrinhgiaoduc')->name('chuong-trinh-giao-duc');
Route::get('/tin-tuc/thong-bao', 'HomeController@thongbao')->name('thongbao');

Route::get('/blogs', 'HomeController@blogs')->name('blogs');
Route::get('/blog/{slug}', 'HomeController@blog_detail')->name('news_detail');
...
Route::group(['middleware' => ['auth']], function(){
	...
	Route::post('/products/vip1', 'ProductController@updateVip1')->name('products.vip1');
	Route::post('/products/vip2', 'ProductController@updateVip2')->name('products.vip2');

...
//recursiveCategorysPost
if(!function_exists('recursiveCategorysPost')){
    function recursiveCategorysPost($data,$parent_id = 0,$Character = '',$post_category=null){
        foreach($data as $key => $value){
            if($value->parent_id == $parent_id){
                if($value->id == $post_category){
                    echo "<option selected='selected' value='".$value->id."'>";
                    echo $Character.$value->name;
                    echo "</option>";
                    unset($data[$key]);
                    recursiveCategorysPost($data,$value->id,$Character.'[--]',$post_category);
                }else{
...
if(!function_exists('recursiveCategorys')){
    function recursiveCategorys($data,$parent_id = 0,$Character = '',$product_category=null){
        foreach($data as $key => $value){
            if($value->parent_id == $parent_id){
                if($value->id == $product_category){
                    echo "<option selected='selected' value='".$value->id."'>";
                    echo $Character.$value->name;
                    echo "</option>";
                    unset($data[$key]);
                    recursiveCategorys($data,$value->id,$Character.'[--]',$product_category);
                }else{
                    echo "<option value='".$value->id."'>";
                    echo $Character.$value->name;
                    echo "</option>";
...
if(!function_exists('recursiveCategorys2')){
    function recursiveCategorys2($data,$parent_id = 0,$Character = '',$subcate_id){
        foreach($data as $key => $value){
            if($value->parent_id == $parent_id){
                if(in_array($subcate_id,$value->parent_id)){
                    echo "<option selected value='".$value->id."'>";
                    echo $Character.$value->name;
                    echo "</option>";
                    unset($data[$key]);
                    recursiveCategorys2($data,$value->id,$Character.'[--]',$subcate_id);
                }
                else{
                    echo "<option value='".$value->id."'>";
                    echo $Character.$value->name;
...
//recursiveCategoryrecursiveCategorys
...
if(!function_exists('formatPriceStr')){

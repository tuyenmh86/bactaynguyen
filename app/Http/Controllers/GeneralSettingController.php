...
class GeneralSettingController extends Controller
{
    ...
    public function storeLogo(Request $request)
    {
        ...
        if($request->hasFile('seach_background')){
            $generalsetting->seach_background = $request->file('seach_background')->store('uploads');
            //ImageOptimizer::optimize(base_path('public/').$generalsetting->admin_login_sidebar);
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        $generalsetting->site_url = $request->site_url;
        $generalsetting->address = $request->address;
        $generalsetting->sologun = $request->sologun;
        $generalsetting->sologun_description = $request->sologun_description;
        $generalsetting->phone = $request->phone;
        $generalsetting->zalo = $request->zalo;
        ...
        if($generalsetting->save()){
            ...
            flash('Cấu hình website đã được thiết lập')->success();
